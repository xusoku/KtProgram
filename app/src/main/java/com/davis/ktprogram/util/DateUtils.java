...
public class DateUtils {
	...
	public static String date2Str(long time) {// yyyy-MM-dd HH:mm:ss
		return date2Str(time, null);
	}
	 ...
	 *            当前的时间
	 */
	public static String date2Str(long time, String format) {// yyyy-MM-dd
																// HH:mm:ss
		if (format == null || format.length() == 0) {
			format = FORMAT;
		}
	...
	public static String[] getCurDateAndTimeStr(String str) {
		Calendar c = str2Calendar(str,FORMAT_FULL);
		String day=date2Str(c,FORMAT_YMD);
		String time=date2Str(c,FORMAT_HM);
