 ...
 */
public class DivasScrollViewPageOne extends ScrollView {
    ...
    public DivasScrollViewPageOne(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public DivasScrollViewPageOne(Context context, AttributeSet attrs, int defStyleAttr) {
